    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <label htmlFor="enail" className="form-label">Email address</label>
                    <input type="email" className="form-control" id="email" name="email" onClick={onChange} aria-describedby="emailHelp" minLength={5} required/>
